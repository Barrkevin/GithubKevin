...
if(isset($_GET['id']) AND $_GET['id'] > 0) {
    $getid = intval($_GET['id']);   /*retourne la valeur numérique entière*/
    $requser = $db->prepare('SELECT * FROM membres WHERE id = ?');
    $requser->execute(array($getid));
    $userinfo = $requser->fetch();  /*récupère une ligne*/
...
inner join categories on products.category_id = categories.id;";
    ...
    <div align="center">
        <h2 id="presentation">Bonjour <?php echo $userinfo['pseudo'] ?></h2>
    ...
    <?php
            ...
            <a href="ajoutproduit.php">
                ...
                ?>
                <a href class="d-none" ="ajoutproduit.php">
            <?php
            }
            ?>
