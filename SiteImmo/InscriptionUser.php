                ...
                if (filter_var($mail, FILTER_VALIDATE_EMAIL)) { /* Si le mail est bon on continue si non erreur */
                    ...
                    if ($mailexist == 0) {
                        ...
                        if ($mdp == $mdp2) {
                            ...
                            $erreur = "Votre compte a bien été créé ! <a href=\"ConnexionUser.php\">Me connecter</a>";
        ...
        <form id="container128" class="offset-sm-2 col-8 bg-white border border-secondary" method="POST"
            ...
            <div class="p-5">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-7">
                        <input type="email" class="form-control" placeholder="Confirmez votre mail" id="mail2"
                               name="mail2" value="<?php if (isset($mail2)) {
                            echo $mail2;
                        } ?>"/>
                    </div>
                </div>
