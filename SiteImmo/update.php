...
$sql = "SELECT biensimmo.id AS bid, biensimmo.adresse AS badresse, biensimmo.name AS bname, 
biensimmo.description AS bdespcription, categories.name as cname, biensimmo.image AS bimage, categories.id 
FROM biensimmo
INNER JOIN categories on biensimmo.category_id = categories.id 
        ...
        <form id="container128" class="offset-sm-2 col-8 bg-white border border-secondary" method="POST"
            ...
            <div class="p-5">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-8">
                        <input id="adresse01" type="text" name="adressage" class="form-control" value="<?php echo $data["badresse"] ?>">
                    </div>
                </div>
